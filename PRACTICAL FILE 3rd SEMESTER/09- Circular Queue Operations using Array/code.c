/*
    DSA Practical 9: Circular Queue Operations using Array
    Operations: Enqueue, Dequeue, Peek, isFull, isEmpty
    ----------------------------------------------------
    Compile : gcc circular_queue_array_operations.c -o circular_queue_array_operations
    Run     : ./circular_queue_array_operations
*/
...
void display() {
    ...
    int cnt = (rear - front + MAX) % MAX + 1;   // number of elements
